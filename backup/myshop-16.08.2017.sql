...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 16 2017 г., 19:29
...
(34, 'Can add Категория', 12, 'add_description'),
(35, 'Can change Категория', 12, 'change_description'),
(36, 'Can delete Категория', 12, 'delete_description');
...
(1, 'pbkdf2_sha256$36000$Gpc75W5R2FaN$PNoVVePhYDs6Kbyp/Wcv5yiy8NRIoTKEbNkuCsh7stA=', '2017-08-16 07:21:03', 1, 'admin', '', '', 'admin@mail.ru', 1, 1, '2017-06-26 05:28:07');
...
(94, '2017-08-10 10:58:50', '2', 'Куртки', 2, '[{"changed": {"fields": ["desc_category"]}}]', 7, 1),
(95, '2017-08-10 14:06:14', '1', 'Если нужно, то здесь будет описание для страницы "Категория"!!!!', 1, '[{"added": {}}]', 12, 1),
(96, '2017-08-10 15:31:41', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 8, 1),
(97, '2017-08-10 15:33:28', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 8, 1),
(98, '2017-08-10 15:37:32', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 8, 1),
(99, '2017-08-10 15:37:40', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 8, 1),
(100, '2017-08-10 15:37:48', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 8, 1),
(101, '2017-08-10 15:58:45', '1', 'sdfgsdfgsdfg', 1, '[{"added": {}}]', 12, 1),
(102, '2017-08-10 16:00:32', '1', 'Если нужно, то здесь можно написать описание для страница "Каталога"', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 12, 1),
(103, '2017-08-10 18:28:18', '1', 'Если нужно, то здесь можно вывести описание для страница "Каталога"', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 12, 1),
(104, '2017-08-10 18:28:38', '1', 'Если нужно, то здесь можно вывести описание для страница "Каталог"', 2, '[{"changed": {"fields": ["desc_catalog"]}}]', 12, 1),
(105, '2017-08-11 09:34:12', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(106, '2017-08-11 10:12:21', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(107, '2017-08-11 10:19:14', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(108, '2017-08-11 10:22:48', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(109, '2017-08-13 09:03:44', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(110, '2017-08-13 09:04:10', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(111, '2017-08-13 09:04:20', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(112, '2017-08-13 09:05:39', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(113, '2017-08-13 09:06:30', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(114, '2017-08-13 09:14:33', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(115, '2017-08-13 09:14:59', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(116, '2017-08-13 09:15:12', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(117, '2017-08-13 09:16:12', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(118, '2017-08-13 09:16:40', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["available"]}}]', 8, 1),
(119, '2017-08-13 09:16:57', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["available"]}}]', 8, 1),
(120, '2017-08-13 09:22:42', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(121, '2017-08-13 09:57:10', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(122, '2017-08-13 09:57:31', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(123, '2017-08-13 09:57:41', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(124, '2017-08-14 05:54:48', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["available"]}}]', 8, 1),
(125, '2017-08-14 05:55:00', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["available"]}}]', 8, 1),
(126, '2017-08-14 05:59:19', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["new"]}}]', 8, 1),
(127, '2017-08-14 06:03:58', '4', 'Куртка кожаная женская', 2, '[{"changed": {"fields": ["vip"]}}]', 8, 1),
(128, '2017-08-14 06:07:19', '4', 'Куртка кожаная женская', 2, '[{"changed": {"fields": ["new"]}}]', 8, 1),
(129, '2017-08-14 06:07:35', '4', 'Куртка кожаная женская', 2, '[{"changed": {"fields": ["new"]}}]', 8, 1),
(130, '2017-08-14 06:46:54', '5', 'Колуны', 1, '[{"added": {}}]', 7, 1),
(131, '2017-08-14 06:47:07', '6', 'Комплекты', 1, '[{"added": {}}]', 7, 1),
(132, '2017-08-14 06:48:23', '7', 'Колун стальной', 1, '[{"added": {}}]', 8, 1),
(133, '2017-08-14 06:49:30', '7', 'Колун стальной', 2, '[{"changed": {"fields": ["image"]}}]', 8, 1),
(134, '2017-08-14 06:54:26', '7', 'Колун стальной', 2, '[{"changed": {"fields": ["image"]}}]', 8, 1),
(135, '2017-08-14 06:54:37', '7', 'Колун стальной', 2, '[{"changed": {"fields": ["image"]}}]', 8, 1),
(136, '2017-08-14 06:56:36', '8', 'Колун стальной', 1, '[{"added": {}}]', 8, 1),
(137, '2017-08-14 06:58:31', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["image"]}}]', 8, 1),
(138, '2017-08-14 06:58:48', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["image"]}}]', 8, 1),
(139, '2017-08-14 07:52:42', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(140, '2017-08-14 07:52:55', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["new"]}}]', 8, 1),
(141, '2017-08-14 07:54:02', '2', 'Кожаная куртка на подстежке 48р.', 2, '[{"changed": {"fields": ["discount", "new"]}}]', 8, 1),
(142, '2017-08-14 07:57:13', '6', 'Модный телефон', 2, '[{"changed": {"fields": ["image", "price"]}}]', 8, 1),
(143, '2017-08-14 08:16:09', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["new"]}}]', 8, 1),
(144, '2017-08-14 08:16:09', '7', 'Колун стальной', 2, '[{"changed": {"fields": ["vip"]}}]', 8, 1),
(145, '2017-08-14 09:50:30', '6', 'Модный телефон', 2, '[{"changed": {"fields": ["discount"]}}]', 8, 1),
(146, '2017-08-15 04:55:29', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["netto", "massa"]}}]', 8, 1),
(147, '2017-08-15 04:55:47', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["netto", "massa"]}}]', 8, 1),
(148, '2017-08-15 05:27:44', '1', 'Черная куртка', 2, '[{"changed": {"fields": ["netto", "massa"]}}]', 8, 1),
(149, '2017-08-15 05:31:56', '1', 'Черная куртка', 2, '[{"changed": {"fields": ["netto", "massa"]}}]', 8, 1),
(150, '2017-08-15 15:01:53', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["netto", "massa"]}}]', 8, 1),
(151, '2017-08-15 15:02:19', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["netto", "massa"]}}]', 8, 1),
(152, '2017-08-15 15:10:01', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["stock"]}}]', 8, 1),
(153, '2017-08-15 15:10:28', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["stock"]}}]', 8, 1),
(154, '2017-08-15 15:10:57', '8', 'Колун стальной', 2, '[{"changed": {"fields": ["stock"]}}]', 8, 1),
(155, '2017-08-16 07:27:43', '5', 'PPTV KING7', 2, '[{"changed": {"fields": ["image"]}}]', 8, 1);
...
(26, 'shop', '0005_remove_product_desc_category', '2017-08-10 10:55:54'),
(27, 'shop', '0006_category_desc_category', '2017-08-10 10:58:00'),
(28, 'shop', '0007_remove_category_desc_category', '2017-08-10 11:07:03'),
(29, 'shop', '0008_description', '2017-08-10 14:03:17'),
(30, 'shop', '0009_delete_description', '2017-08-10 15:10:08'),
(31, 'shop', '0010_product_desc_catalog', '2017-08-10 15:27:44'),
(32, 'shop', '0011_remove_product_desc_catalog', '2017-08-10 15:52:57'),
(33, 'shop', '0012_description', '2017-08-10 15:56:58'),
(34, 'shop', '0013_auto_20170811_1229', '2017-08-11 09:30:12'),
(35, 'shop', '0014_auto_20170814_0853', '2017-08-14 05:53:32'),
(36, 'shop', '0015_product_netto', '2017-08-15 04:46:22'),
(37, 'shop', '0016_product_massa', '2017-08-15 04:53:15'),
(38, 'shop', '0017_auto_20170815_0830', '2017-08-15 05:30:54');
...
('0zwqfhqk5w8gu1uzluzchhxn0d5r2osk', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-26 21:28:18'),
...
('23ad74i6v06r49xli7m2n66gt6aqf1fh', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 05:30:43'),
...
('43r4ri8jzjb85nd75xx25kk5lnbhtsx1', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-30 14:50:38'),
...
('46i1jl15gcd9pt8ncqdsa12k2g1k5du4', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-26 23:53:41'),
...
('494lwzg1vxbqs0v3vcp4c4hvlahtrtls', 'ZDNjZGY3MThjMzQyODIxYWIzOTk3ODJkODg1YTBlMGUzOWYzNWJmZDp7ImNhcnQiOnsiNSI6eyJwcmljZSI6Ijc1MDAuMDAiLCJxdWFudGl0eSI6MX19fQ==', '2017-08-28 08:46:16'),
...
('4hfip7n99lwlxwmzfkmvdqc2ibipowuy', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-29 04:33:54'),
...
('4rnni8o2byxodxrjzjocqp7m4j6mix4p', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-30 15:11:13'),
...
('57vxetzifkislwiuite9x24a4aki969f', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-26 21:46:04'),
...
('62mt7u1rrjwg0vj9n9q99jk8lgjgsgnu', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 05:54:49'),
...
('6mm0axry9hq7tf7czffu1gs68re3btjd', '', '2017-08-30 07:47:31'),
...
('6rvrq4xc2e1i8eb22n7oq3g5uqw8e6nr', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-30 11:04:44'),
...
('70w4tbikquejm1kybh467gvqe04kqm5a', '', '2017-08-29 14:52:55'),
...
('7myjzzcokjadxg6bhijnv6klzgclnsgb', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-26 21:06:29'),
...
('bbgjuzes7o007vr9apc3mc8rqtpkv85s', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-29 11:01:21'),
('c0ynde9dz6cvojuwy3h7q9ux7yp2x8l5', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-29 08:02:21'),
...
('dhd565nsx0bg0m7tlsxfins5s3aec7n4', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 00:08:15'),
('dm7v2zq53cipz8njrg49rnmhlgwqxpxe', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 05:40:01'),
...
('epu9m5vo6q1uhfvj59v3tcdgowas74qx', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 05:38:52'),
...
('f0miku6dnjrzaaue4sji95gnen0a2brq', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 17:14:27'),
...
('gl7052z04bxn3p2fjzuo80n59e38ithu', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 07:39:20'),
...
('hi72hkskghxmnwvu5fkvfg3zzmnhozzq', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 05:24:35'),
...
('i0zrs6brkk809wvyei00zy3pvtb5vpbu', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-26 21:47:52'),
...
('i9xocxk8zwq2k2yjn9ntkzfw2j06bprk', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-26 14:49:18'),
...
('ijsbhre3hgu035bf0uiv3tyhkqtanuwe', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 12:14:35'),
...
('ixyjqvb82i0whgv0a3crgpz3hma086cv', 'ZDNjZGY3MThjMzQyODIxYWIzOTk3ODJkODg1YTBlMGUzOWYzNWJmZDp7ImNhcnQiOnsiNSI6eyJwcmljZSI6Ijc1MDAuMDAiLCJxdWFudGl0eSI6MX19fQ==', '2017-08-26 11:21:46'),
...
('jtbww05w4bdczk1kuogym582s72fj6h1', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-24 23:37:13'),
...
('lkvztwg7qqqmbhx1fvg8rczpzk60evjl', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 05:18:40'),
('lly0zjw0b5kawidmq31gdv9jtvlvoyyi', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 19:49:29'),
...
('lxstfg2oe68kkg8ceqmvg6v8rj40ahz8', 'ZDNjZGY3MThjMzQyODIxYWIzOTk3ODJkODg1YTBlMGUzOWYzNWJmZDp7ImNhcnQiOnsiNSI6eyJwcmljZSI6Ijc1MDAuMDAiLCJxdWFudGl0eSI6MX19fQ==', '2017-08-28 08:36:02'),
...
('n7ez9s605rr1sijq8ga3bor0gqmsv10r', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 07:03:17'),
('na8k0j7dc4iqp4myllji2uwz25gv7nuk', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-29 06:52:45'),
...
('o6iyuni3scqmce0o1e0kycd5d7z62ooh', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 05:42:31'),
('oah2arrp2xechxf00fbfj2okdv58e352', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 16:35:00'),
...
('or46uprd55s6suia3c7agbq9u7lall8k', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 05:28:58'),
...
('ov2heht4gpvrotjy3g8qxa1k7n3b7bg1', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 08:23:00'),
...
('q1woxrrucl950244ou9qkh6ihfbni1mp', 'ZDNjZGY3MThjMzQyODIxYWIzOTk3ODJkODg1YTBlMGUzOWYzNWJmZDp7ImNhcnQiOnsiNSI6eyJwcmljZSI6Ijc1MDAuMDAiLCJxdWFudGl0eSI6MX19fQ==', '2017-08-26 10:57:06'),
...
('t7srcyv6s6au589sk6lru3ae3gqwlmr8', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 05:38:54'),
('t91u3qeh3pm9v7vqxfcimveu32wthm7c', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-25 08:31:20'),
...
('uorerj5vjdg7bgbjwhkqqwxknia8ry3c', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 12:14:39'),
...
('uw14zubz6fl9pjpwj7hwdcu7rwyxynb2', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 08:35:35'),
...
('w6mytkrvtpmeu97q7mdhq55zg0q37355', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 08:39:32'),
('w9ooh2r6dqjpiahvu298k7x88dovkzl1', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-28 16:21:44'),
...
('wpx2gz7y7q8sj1p96oea0nu1f75mjtah', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-27 16:44:24'),
...
('ww5c2mayipva5dyi2hac927r1eg9sfdm', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-30 14:49:32'),
...
('y3c8ht3t0plakwfcvywr6aa2jn8hgy8x', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-29 06:52:47'),
...
('yszkmot81vm1ftkjzpvtalbn20432s6g', 'ZDNjZGY3MThjMzQyODIxYWIzOTk3ODJkODg1YTBlMGUzOWYzNWJmZDp7ImNhcnQiOnsiNSI6eyJwcmljZSI6Ijc1MDAuMDAiLCJxdWFudGl0eSI6MX19fQ==', '2017-08-26 11:32:24'),
('yt2wn46v404kbax5vt4wqhlaqf5um7vf', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-29 06:52:47'),
...
('zo0nsap4dqbbpga6ac4n9rcc8zfsjm8s', 'Mjg4Y2M1NmRkNmY1NzQzOTU5MzVkMWY3MzdhMGQ0ZjhlYWYwZTVkOTp7ImNhcnQiOnt9fQ==', '2017-08-30 12:13:52'),
...
(5, 'Колуны', 'koluny', ''),
(6, 'Комплекты', 'komplekty', '');

-- --------------------------------------------------------

--
-- Структура таблицы `shop_description`
--

CREATE TABLE IF NOT EXISTS `shop_description` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `desc_catalog` longtext NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- Дамп данных таблицы `shop_description`
--

INSERT INTO `shop_description` (`id`, `desc_catalog`) VALUES
(1, 'Если нужно, то здесь можно вывести описание для страница "Каталог"');
...
INSERT INTO `shop_product` (`id`, `name`, `slug`, `image`, `description`, `price`, `stock`, `available`, `created`, `updated`, `category_id`, `discount`, `new`, `vip`, `netto`, `massa`) VALUES
(1, 'Черная куртка', 'chernaya-kurtka', 'products/17/06/26/t-yv01-gray-2.jpg', 'Кожаная куртка французской фирмы Azzaro. Сделана из овечьей кожи высшей категории. В отличном состоянии. Размер 50-52.', '3000.00', 15, 1, '2017-06-26 06:53:36', '2017-08-15 05:31:56', 2, NULL, 0, 0, '', ''),
(2, 'Кожаная куртка на подстежке 48р.', 'kozhanaya-kurtka-na-podstezhke-48r', 'products/17/06/26/kozhanaya-kurtka-na-podstezhke.jpg', 'Женская кожаная куртка на подстежке в отличном состоянии 48р.', '3000.00', 1, 1, '2017-06-26 11:21:55', '2017-08-14 07:54:02', 2, NULL, 1, 0, '', ''),
(3, 'Плащ,Кожаная куртка,черно-бурая лиса', 'plashkozhanaya-kurtkacherno-buraya-lisa', 'products/17/06/26/plaschkozhanaya-kurtkacherno-buraya-lisa-lugansk.jpg', 'Куртка кожаная 2 в 1.Отстегивается низ.Размер 48-50.Воротник ,рукава черно-бурая лиса. Подкладка на молнии.', '4000.00', 2, 1, '2017-06-26 11:32:17', '2017-06-26 11:32:17', 2, NULL, 0, 0, '', ''),
(4, 'Куртка кожаная женская', 'kurtka-kozhanaya-zhenskaya', 'products/17/06/26/kurtka-kozhanaya-zhenskaya-lugansk_rev002.jpg', 'Кожаная куртка с капюшоном и дополнительной подстежкой(при необходимости отстегивается). Размер 48-50. Состояние хорошее', '3200.00', 1, 1, '2017-06-26 11:34:39', '2017-08-14 06:07:35', 2, NULL, 0, 1, '', ''),
(5, 'PPTV KING7', 'pptv-king7', 'products/17/08/16/20161108154921_38694.jpg', 'PPTV – один из сильных конкурентов LeTV на китайском рынке платформ для стримминга видео. И как только LeTV вышла на рынок смартфонов, аналогичные планы появились у PPTV. На днях компания провела пресс-конференцию в Пекине, в рамках которой показала свои первые смартфоны – King 7 и King 7S. Оба смартфона получили 6" Quad HD-экраны, однако у King 7S панель может демонстрировать 3D-контент, для просмотра которого не нужны очки. Используется технология RSPT-MC 3D, направляющая картинку с одних рядов пикселей в один глаз, а с других – в другой. При этом наилучший эффект 3D создаётся при расстоянии от экрана до глаз 32 см. Дисплей является единственным отличием смартфонов (точнее, есть ещё одно: King 7S на 0,3 мм толще из-за конструкции дисплея), однако именно он определяет разницу цен. PPTV King 7 стоит 2199 юаней (23,5 тысячи рублей), а King 7S – 2699 юаней (29 тысяч рублей).', '7500.00', 1, 1, '2017-06-26 11:54:17', '2017-08-16 07:27:43', 4, '6500.00', 0, 0, '', ''),
(6, 'Модный телефон', 'modnyj-telefon', 'products/17/08/14/FulHD.jpg', 'Самый модный телефон', '11500.00', 5, 1, '2017-08-09 12:22:51', '2017-08-14 09:50:30', 4, '10500.00', 0, 0, '', ''),
(7, 'Колун стальной', 'kolun-stalnoj', 'products/17/08/14/grid-home-1.jpg', 'Колун стальной для колки дров, размер 28мм.', '2450.00', 5, 1, '2017-08-14 06:48:23', '2017-08-14 08:16:09', 5, NULL, 0, 1, '', ''),
(8, 'Колун стальной', 'kolun-stalnoj', 'products/17/08/14/grid-home-7.jpg', 'Новый колун стальной 30мм', '2450.00', 15, 1, '2017-08-14 06:56:36', '2017-08-15 15:10:57', 5, NULL, 1, 0, '30x28x35', '5.5');
